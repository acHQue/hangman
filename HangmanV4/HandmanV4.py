...
def takeCheck(lives):
    ...
    Then location is also removed from the starlist and the user input inserted to the same location of the working list, and the flow restarts the takecheck function.
